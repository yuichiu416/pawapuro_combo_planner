  ...
  return (
    <header className="space-y-6">
      ...
      <div className="flex items-center py-3 px-1 border-t border-slate-200/60 gap-3">
        {/* Toggle 1: POSITION ICONs (Icon Removed, Text Only) */}
        <button 
          onClick={() => setShowPositionIcon(!showPositionIcon)} 
          className={cn(
            "px-4 py-2 border-2 rounded-xl text-[10px] font-black transition-all uppercase", 
            showPositionIcon 
        ...
        {/* Toggle 2: Owned Related Filter (Icon Removed, Text Only) */}
        <button 
