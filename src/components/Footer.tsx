    ...
    <footer className="w-full bg-white border-t border-slate-200 px-6 py-2 shrink-0">
      <div className="flex flex-row justify-between items-center max-w-full mx-auto">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[10px] font-black italic tracking-tighter text-slate-900 uppercase">
        ...
        <p className="hidden lg:block text-[8px] text-slate-400 uppercase font-medium tracking-tight">
        ...
        <div className="flex items-center gap-4">
          <a 
            ...
            className="flex items-center gap-1.5 text-[9px] font-black text-slate-600 hover:text-rose-500 transition-colors uppercase italic group"
          >
