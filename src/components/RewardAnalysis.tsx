      ...
      {!collapsed && (
        <>
          ...
          <div className="flex-1 flex flex-col gap-8 min-h-0 animate-in fade-in duration-300">
            ...
            {/* 2. ROSTER STATUS (UPDATED FOR MANAGER SEPARATION) */}
            <div className={cn(
              ...
              {!roster.isValid && (
                <div className="mt-4 pt-3 border-t border-rose-100">
                  <p className="text-[9px] font-black text-rose-500 uppercase italic leading-tight">
                    {roster.errors.total ? "⚠️ Exceeded 23-scout limit" : "⚠️ Check positional requirements"}
                  </p>
                </div>
              )}
            </div>
