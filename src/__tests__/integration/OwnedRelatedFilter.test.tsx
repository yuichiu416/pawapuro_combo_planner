...
import { cleanup, getByTestId, render, screen, waitFor, within } from '@testing-library/react';
...
describe('Owned Related Filter - Discovery Flow', () => {
  ...
  it('allows searching, adding a character, and filtering for their combos', async () => {
    ...
    expect(await screen.getByTestId('desktop-character-sidebar-undo-toast')).toBeInTheDocument();
